...
const updateRelatedProjects = (projects, data) => {
    const byId = {
        ...projects.byId,
        ...data.reduce((prev, project) => {
            prev[project.id] = project;
...
export default handleActions(
    {
        ...
        [RECEIVE_SEARCH_ALL_PROJECTS_RESULT]: (state, action) => {
            const{ data } = action.payload;
            return Object.assign({}, state, {
                relatedProjects: updateRelatedProjects(data, data),
                isFetching: false
            });
        },
        ...
        [REQUEST_SEARCH_ALL_PROJECTS]: (state, action) => {
            const{ keyword } = action.payload;
            return Object.assign({}, state, {
                searchQuery: keyword
            });
