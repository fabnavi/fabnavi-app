...
export const REQUEST_SEARCH_ALL_PROJECTS = 'REQUEST_SEARCH_ALL_PROJECTS';
export const RECEIVE_SEARCHING_PROJECTS_RESULT = 'RECEIVE_SEARCHING_PROJECTS_RESULT';
export const RECEIVE_SEARCH_ALL_PROJECTS_RESULT = 'RECEIVE_SEARCH_ALL_PROJECTS_RESULT';
...
export const requestSearchAllProjects = createAction(REQUEST_SEARCH_ALL_PROJECTS, keyword => {
    return {
        keyword
    };
});
...
export const receiveSearchAllProjectsResult = createAction(RECEIVE_SEARCH_ALL_PROJECTS_RESULT, data => {
    return {
        data
    };
});
