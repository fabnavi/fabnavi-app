            ...
            <div className="help-page">
                ...
                <div className="container">
                    ...
                    <div className="player-container">
                        ...
                        <ul>
                            <li className="list-test"><p>プロジェクトが画像の場合:　マウスのクリックで操作します．左クリックで前のページ，右クリックで次のページに進みます．また，キーボードの左右キーでも同じ操作が可能です．</p></li>
                            <li className="list-test"><p>プロジェクトが動画の場合:　マウスのクリックで操作します．左クリックで動画が再生されます．もう一度クリックすると，再生は止まります．</p></li>
                            <li className="list-test"><p>Player Modeをやめる場合:　下にスクロールすると，Back Buttonがあります．クリックすると，ホーム画面に遷移します．また，キーボードのESCキーでも同様の操作が可能です．</p></li>
                        </ul>
