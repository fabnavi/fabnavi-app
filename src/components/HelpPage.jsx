        ...
        return (
            <div className="help-page">
                ...
                <div className="container">
                    ...
                    <MenuDescription src="./images/back.png" title="Back Button">
                        一つ前の画面に戻ります.
                    </MenuDescription>
                    <hr />
                    ...
                    <MenuDescription src="./images/myproject.png" title="Project Button">
                    ...
                    <MenuDescription src="./images/help.png" title="Help Page Button">
                        Fabnavi Help Pageに遷移します．
                    </MenuDescription>
                    <hr />

                    <MenuDescription src="./images/update.png" title="Update Project Button" >
