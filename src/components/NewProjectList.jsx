...
const debug = Debug('fabnavi:jsx:NewProjectList');

class NewProjectList extends React.Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(NewProjectList);
